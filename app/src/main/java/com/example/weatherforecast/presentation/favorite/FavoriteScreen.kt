...
import com.example.weatherforecast.presentation.favorite.composables.AddToFavBtn
import com.example.weatherforecast.presentation.favorite.composables.EmptyFavorite
import com.example.weatherforecast.presentation.favorite.composables.FavoriteCard
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Scaffold(
            floatingActionButton = {
                AddToFavBtn(onClick = { onAddItemToFav() })
            },
        ) { innerPadding ->
