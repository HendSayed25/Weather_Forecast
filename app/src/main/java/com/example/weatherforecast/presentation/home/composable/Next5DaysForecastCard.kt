        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            for (i in 0..<dailyForecastItems.size) {
                DailyForecastItem(
                    ...
                    maxTemp = dailyForecastItems[i].maxTemp.toInt(),
                    minTemp = dailyForecastItems[i].minTemp.toInt(),
                    isDay = isDay
                )
            }
        }
